...
Администратор вводит ФИО, роль и при необходимости магазин. Backend генерирует постоянный ключ доступа и возвращает его в ответе. Этот ключ можно показать администратору и выдать сотруднику для первого входа.
